        ...
        <a-form-item>
          <a-input-password
            ...
            v-decorator="[
              'password',
              {
                rules: [{ required: true, message: '密码不能为空' }, { validator: this.handlePasswordLevel }],
                validateTrigger: ['change', 'blur'],
              },
            ]"
          ></a-input-password>
      ...
      <a-form-item>
        <a-input
          ...
          v-decorator="[
            ...
            {
              rules: [
                { required: true, message: '手机号不能为空', pattern: /^1[3456789]\d{9}$/ },
...
import { scorePassword } from '@/utils/CommonUtil';
