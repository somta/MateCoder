          ...
          <div class="account-center-tags">
            ...
            <div>
              <template v-for="(tag, index) in tags">
                ...
                <a-tag v-else :closable="index !== 0" :close="() => handleTagClose(tag)">{{ tag }}</a-tag>
              </template>
              <a-input
...
import AppPage from './page/App.vue';
import { ref } from "vue";
...
export default class CenterPage extends Vue {
  ...
  handleTabChange(value: string, type: string) {
   ...
   * @param removeTag
   */
  handleTagClose(removeTag:string) {
